...
class cell_original(Dataset):
    def __init__(self, transform=None, state='train'):
        self.data_split_root = r'/data2/siyuan/NeurIPS22-CellSeg_processed/cell_path.pkl'
